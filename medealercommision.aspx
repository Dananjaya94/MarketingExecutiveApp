<%@ Page Language="C#" AutoEventWireup="true" CodeFile="medealercommision.aspx.cs" Inherits="medealercommision" %>
...
;">
    <h1 style="text-align:center;background-color:#000b19;color:#fff;font-weight:bolder;font-family:Calibri;letter-spacing:7px;word-spacing:15px;">Dealer Commission</h1>
    <!--customer details-->   
