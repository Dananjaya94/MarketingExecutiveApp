<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="productmenu.aspx.cs" Inherits="productmenu" %>
<!DOCTYPE html>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                        <div class="card border-left-success shadow h-100 py-2">
                                        <a style="text-decoration:none" href="pdf/Ceylinco VIP On The Spot - F.pdf">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-success text-uppercase mb-1">Ceylinco VIP On The Spot </div>
<%--                          <div class="h8 mb-0 font-weight-bold text-gray-800">File Size - 757KB</div>--%>
                            <sub>File Size - 757KB</sub>
                        </div>
                        <div class="col-auto">
