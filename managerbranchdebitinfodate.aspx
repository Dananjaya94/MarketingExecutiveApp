<%@ Page Language="C#" AutoEventWireup="true" CodeFile="managerbranchdebitinfodate.aspx.cs" Inherits="managerbranchdebitinfodate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Branch Debit Information</title>
    <meta charset="utf-8">
...
<div class="container" style="padding-left:5%;background-color:#b4f9e3;">
    <h1 style="text-align:center;background-color:#000b19;color:#fff;font-weight:bolder;font-family:Calibri;letter-spacing:7px;word-spacing:15px;">Branch Debit Information Date Range</h1>
    <!--customer details-->   
...
<%--                        <asp:Panel ID="Panel2" runat="server" Height="400px" ScrollBars="Both" >--%>
                           <asp:GridView ID="grid1" runat="server"  CssClass="table table-striped table-bordered table-hover" AutoPostBack="true" 
                               AlternatingRowStyle-BackColor="WhiteSmoke" FooterStyle-BackColor="WhiteSmoke"
