<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mevisitsum.aspx.cs" Inherits="quotation" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ME Visit Summary</title>
    <meta charset="utf-8">
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container" style="padding-left: 5%; background-color: #b4f9e3;">
            <h1 style="text-align: center; background-color: #000b19; color: #fff; font-weight: bolder; font-family: Calibri; letter-spacing: 7px; word-spacing: 15px;">ME Visit Summary</h1>
            <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <table align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px;">
                                            <asp:DropDownList ID="DropDownListme" AppendDataBoundItems="true" runat="server" class="form-control" Width="286px"></asp:DropDownList>
                                    </tr>
                ...
                <div class="well" style="margin-top: 5px;">
                    ...
                    <div class="row">
                        ...
                        <asp:GridView ID="grid1" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" AutoPostBack="true"
                            AlternatingRowStyle-BackColor="WhiteSmoke" FooterStyle-BackColor="WhiteSmoke" ShowFooter="true" OnRowCommand="grid1_RowCommand">
                            <Columns>
                                <asp:BoundField DataField="VISIT_DATE" HeaderText="VISIT_DATE" SortExpression="VISIT_DATE" />
                                <asp:BoundField DataField="ME_CODE" HeaderText="ME_CODE" SortExpression="ME_CODE" />
                                <asp:BoundField DataField="ME_NAME" HeaderText="ME_NAME" SortExpression="ME_NAME" />
                                <asp:BoundField DataField="TOTAL_VISITS" HeaderText="TOTAL_VISITS" SortExpression="TOTAL_VISITS" />
                                <asp:BoundField DataField="SAME_DAY_CLOSED" HeaderText="SAME_DAY_CLOSED" SortExpression="SAME_DAY_CLOSED" />
                                <asp:BoundField DataField="PROSPECTS" HeaderText="PROSPECTS" SortExpression="PROSPECTS" />
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Button Text="Check" runat="server" CommandName="managercheck" CommandArgument="<%# Container.DataItemIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
