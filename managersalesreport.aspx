<%@ Page Language="C#" AutoEventWireup="true" CodeFile="managersalesreport.aspx.cs" Inherits="managersalesreport" %>
...
<td style="padding: 5px;">
    ...
    <tr>
 <td style="padding: 5px;"><asp:Label ID="Label14" runat="server" Text="ME"></asp:Label></td>

<td style="padding: 5px;">
    <asp:DropDownList ID="cmbme" AppendDataBoundItems="true" class="form-control" Width="286px" runat="server">
...
<%--                        <asp:Panel ID="Panel3" runat="server" Height="400px" ScrollBars="Both" >--%>
                               <asp:GridView ID="grid1" runat="server"    CssClass="table table-striped table-bordered table-hover"
                                    AlternatingRowStyle-BackColor="WhiteSmoke" FooterStyle-BackColor="WhiteSmoke" AutoPostBack="true"  >
