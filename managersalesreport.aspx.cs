...
public partial class managersalesreport : System.Web.UI.Page
{
    Connection db;
    ...
    {
        string query = "select sfc_code,sfc_code||' - '||sfc_initials||' '||sfc_surname namee from sm_m_sales_force " +
        ...
        try
        {
            ...
            cmbme.DataSource = cmd.ExecuteReader();
            cmbme.Items.Clear();
            cmbme.Items.Add(new ListItem("-- Select Me --", "0"));
           // cmbme.Items[0].Enabled = false;
            cmbme.DataTextField = "namee";
            cmbme.DataValueField = "sfc_code";
            cmbme.DataBind();
        }
        catch (Exception ex)
        {
    ...
    protected void getMeData()
    {
        ...
        prm2.Value = cmbme.SelectedValue;
    ...
    public void clear()
    {
        ...
        TextBoxmename.Text = "";
        TextBoxtype.Text = "";
        TextBoxviewyear.Text = "";
        TextBoxmonth.Text = "";
        TextBoxnewplan.Text = "";
        TextBoxrenewalplan.Text = "";
        TextBoxtotal.Text = "";
        TextBoxlastyear.Text = "";
        TextBoxachievement.Text = "";
        TextBoxgrowth.Text = "";
    }
