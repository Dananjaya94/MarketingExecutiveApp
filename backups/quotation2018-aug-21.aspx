...
<%--          <table  id="pnlGridView" runat="server" >
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <asp:TextBox ID="txtSumInsured" runat="server" CssClass="inputStyle" AutoPostBack="true" onkeypress="return isNumberKey(event)" onkeyup = "javascript:this.value=Comma(this.value);"></asp:TextBox>
