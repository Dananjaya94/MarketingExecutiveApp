...
public partial class AllIslandPromotion : System.Web.UI.Page
{
    ...
    public int savedata()
    {
        ...
        try
        {
            ...
            cmd.Parameters.Add("wkmfl_mev_flo_date", OracleType.DateTime).Value = Convert.ToDateTime(TextBoxnxtFallowdate.Text);
            cmd.Parameters.Add("wkmev_busi_closed", OracleType.VarChar, 5).Value = DropDownListbus.SelectedValue.ToString();
            cmd.Parameters.Add("wkmev_busi_closed_date", OracleType.DateTime).Value = Convert.ToDateTime(TextBoxaddbusclosdate.Text);
