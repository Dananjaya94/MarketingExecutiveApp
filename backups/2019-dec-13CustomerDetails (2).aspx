...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
 ...
 <span id="spfirstname"></span>
        ...
        <asp:DropDownList ID="cmbbisocu" runat="server"   Width="40%"
                                                class="form-control" AppendDataBoundItems="True" AutoPostBack="True" style="border-style:solid" ></asp:DropDownList></br>
        ...
        <asp:DropDownList ID="DropDownListpoltype" runat="server"   Width="40%"
          style="border-style:solid" class="form-control" AppendDataBoundItems="True" AutoPostBack="True" ></asp:DropDownList></br>
<span id="lblError" style="color: red"></span>
        ...
        <asp:TextBox ID="TextBoxredate" placeholder="enter renewal date"    class="form-control" Width="60%" runat="server">
             ...
             <label for="email">Followup Date *</label>
        <asp:TextBox ID="TextBoxfalldate" placeholder="enter fallowup date"  style="border-style:solid"  class="form-control" Width="60%" runat="server">
        </asp:TextBox></br>
