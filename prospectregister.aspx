<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prospectregister.aspx.cs" Inherits="prospectregister" %>
...
;">
    <h1 style="text-align:center;background-color:#000b19;color:#fff;font-weight:bolder;font-family:Calibri;letter-spacing:7px;word-spacing:15px;">Prospect Register</h1>
    <!--customer details-->   
...
<%--                        <asp:Panel ID="Panel2" runat="server" Height="400px" ScrollBars="Both" >--%>
                           <asp:GridView ID="grid1" runat="server" AutoGenerateColumns="true" width="100%" CssClass="table table-striped table-bordered table-hover" 
                               AlternatingRowStyle-BackColor="WhiteSmoke" FooterStyle-BackColor="WhiteSmoke"
                               AutoPostBack="true"   ShowFooter="true">
