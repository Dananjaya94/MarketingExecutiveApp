<%@ Page Language="C#" AutoEventWireup="true" CodeFile="managercollectionreport.aspx.cs" Inherits="managercollectionreport" %>
...
;">
    <h1 style="text-align:center;background-color:#000b19;color:#fff;font-weight:bolder;font-family:Calibri;letter-spacing:7px;word-spacing:15px;">Collection Report</h1>
    <!--customer details-->   
...
<%--                        <asp:Panel ID="Panel2" runat="server" Height="400px" ScrollBars="Both" >--%>
                           <asp:GridView ID="grid1" runat="server"  CssClass="table table-striped table-bordered table-hover" AutoPostBack="true" AutoGenerateColumns="true"  ShowFooter="true">
