 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesPlanData.aspx.cs" Inherits="AllIslandPromotion" %>
...
<%--$(function () {
      $("#<%=TextBoxyear.ClientID %>").change(function () {


            $.ajax({
                        url: '<%=ResolveUrl("~/service.asmx/Lastyearamount") %>',
                        data: JSON.stringify({ 'mecode': '51333','lastdate':$("#TextBoxyear").val() }),
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                            
                            $("#<%=TextBoxlastyearcost.ClientID %>").val(data.d);
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <asp:TextBox ID="TextBoxyear" placeholder="enter year" class="form-control" Width="40%" runat="server"></asp:TextBox><br />
        
         <asp:Button ID="Buttoncal" runat="server" Text="Get Last Year Premium" class="btn btn-primary"  style="padding-left:10px" OnClick="Buttoncal_Click"/>
        ...
        <asp:TextBox ID="TextBoxlastyearcost"  class="form-control" Width="60%" runat="server"></asp:TextBox></br>
