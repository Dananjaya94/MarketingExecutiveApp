<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerCancelationList.aspx.cs" Inherits="quotation" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>TO BE CANCELLATION LIST </title>
    <meta charset="utf-8">
...
<div class="container" style="padding-left:5%;background-color:#b4f9e3;">
    <h1 style="text-align:center;background-color:#000b19;color:#fff;font-weight:bolder;font-family:Calibri;letter-spacing:7px;word-spacing:15px;">TO BE CANCELLATION LIST</h1>
    <!--customer details-->   
...
<table align="center">
 <tr>
  <td style="padding: 5px;"><asp:Label ID="Label4" runat="server" Text="ME"></asp:Label></td>
                ...
                <td style="padding: 5px;"><asp:DropDownList ID="DropDownListme" AppendDataBoundItems="true"    runat="server" class="form-control"  Width="286px"></asp:DropDownList><//td>
            </tr>
...
<%--                        <asp:Panel ID="Panel2" runat="server" Height="400px" ScrollBars="Both" >--%>
                           <asp:GridView ID="grid1" runat="server" Font-Size="Smaller"  CssClass="table table-striped table-bordered table-hover" AutoPostBack="true"   ShowFooter="true">
