...
public partial class quotation : System.Web.UI.Page
{
    ...
    protected void getXCancelationDetails()
    {
        ...
        cmd.CommandText = "pk_app_me_reports.open_BRN_cancel_det";
        ...
        try
        {
            ...
            {
                cnt = cnt + 1;
                grow.Cells[6].Text = Convert.ToDouble(grow.Cells[6].Text).ToString("N2");
                grow.Cells[7].Text = Convert.ToDouble(grow.Cells[7].Text).ToString("N2");

                tot = tot + Convert.ToDouble(grow.Cells[6].Text);
                phys = phys + Convert.ToDouble(grow.Cells[7].Text);
    ...
    {
        if (txtfromdate.Text != "" && txttodate.Text != ""&& DropDownListbranch.SelectedValue!="0")
        {
            getXCancelationDetails();
