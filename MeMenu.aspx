<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="MeMenu.aspx.cs" Inherits="Home" %>
...
<%--          <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                        <div class="card border-left-success shadow h-100 py-2">
                                        <a style="text-decoration:none" href="salesAch.aspx">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-success text-uppercase mb-1">Sales achievment</div>
                        </div>
                        <div class="col-auto">
                ...
                <!-- Earnings (Monthly) Card Example -->
                 <div class="col-xl-4 col-md-6 mb-4">
                        <div class="card border-left-primary shadow h-100 py-2">
                                        <a style="text-decoration:none" href="MePer.aspx">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-primary text-uppercase mb-1">Product wise achivement and growth</div>
                        </div>
                        <div class="col-auto">
                          <i class="fas fa-edit fa-2x text-gray-300"></i>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                      <div class="card border-left-warning shadow h-100 py-2">
                                        <a style="text-decoration:none" href="meRene.aspx">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-warning text-uppercase mb-1">Renewable List</div>
                        </div>
                        <div class="col-auto">
                          <i class="fas fa-edit fa-2x text-gray-300"></i>
                        </div>
               ...
               <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                      <div class="card border-left-danger  shadow h-100 py-2">
                                        <a style="text-decoration:none" href="debitOut.aspx">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-danger text-uppercase mb-1">Debit Outstanding List</div>
                        </div>
                        <div class="col-auto">
                          <i class="fas fa-edit fa-2x text-gray-300"></i>
                        </div>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                      <div class="card border-left-success shadow h-100 py-2">
                                        <a style="text-decoration:none" href="openOutcan.aspx">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-success text-uppercase mb-1">Open auto cancellation</div>
                        </div>
                        <div class="col-auto">
                          <i class="fas fa-edit fa-2x text-gray-300"></i>
                        </div>
               ...
               <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                      <div class="card border-left-primary shadow h-100 py-2">
                                        <a style="text-decoration:none" href="IntClaim.aspx">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-primary text-uppercase mb-1">Intimated Claims</div>
                        </div>
                        <div class="col-auto">
                          <i class="fas fa-edit fa-2x text-gray-300"></i>
                        </div>
            ...
            <form runat="server">
               ...
               <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                      <div class="card border-left-success shadow h-100 py-2">
                                        <a style="text-decoration:none" href="medealercommision.aspx">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-success text-uppercase mb-1">Dealer Commission</div>
                        </div>
                        <div class="col-auto">
                          <i class="fas fa-edit fa-2x text-gray-300"></i>
                        </div>
