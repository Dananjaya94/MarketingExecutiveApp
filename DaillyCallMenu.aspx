<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DaillyCallMenu.aspx.cs" Inherits="Home" %>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                        <div class="card border-left-success shadow h-100 py-2">
                                        <a style="text-decoration:none" href="VisitUpdateMenu.aspx">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-success text-uppercase mb-1">Customer visit update</div>
                        </div>
                        <div class="col-auto">
 ...
 <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                        <div class="card border-left-warning shadow h-100 py-2">
                                        <a style="text-decoration:none" href="ReportMenu.aspx">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-warning text-uppercase mb-1">Reports</div>
                        </div>
                        <div class="col-auto">
                          <i class="fas fa-edit fa-2x text-gray-300"></i>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                        <div class="card border-left-primary shadow h-100 py-2">
                                        <a style="text-decoration:none" href="salesMenu.aspx">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <%--<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repair Details Entry Form</div>--%>
                          <div class="h6 mb-0 font-weight-bold text-primary text-uppercase mb-1">sales Plan</div>
                        </div>
                        <div class="col-auto">
                          <i class="fas fa-edit fa-2x text-gray-300"></i>
                        </div>
