<%@ Page Language="C#" AutoEventWireup="true" CodeFile="crossselling.aspx.cs" Inherits="quotation" %>
...
<div class="container" style="padding-left:5%;background-color:#b4f9e3;">
    <h1 style="text-align:center;background-color:#000b19;color:#fff;font-weight:bolder;font-family:Calibri;letter-spacing:7px;word-spacing:15px;">Cross selling</h1>
    <!--customer details-->   
