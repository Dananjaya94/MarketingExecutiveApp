...
public partial class quotation : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            // String username;
            TextBoxbranch.Text = Session["sfc_brn_code"].ToString();//"AV00";//
            TextBoxmecode.Text = Session["sfc_code"].ToString();//"51333"; //
            //getMeData();
    ...
    protected void getMeData()
    {
        ...
        cmd.CommandText = "pk_app_me_reports.open_me_renewable";
