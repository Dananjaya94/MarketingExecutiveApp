<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerMeWiseRefundRa.aspx.cs" Inherits="quotation" %>
...
;">
    <h1 style="text-align:center;background-color:#000b19;color:#fff;font-weight:bolder;font-family:Calibri;letter-spacing:7px;word-spacing:15px;">ME Wise Refund Ration</h1>
    <!--customer details-->   
