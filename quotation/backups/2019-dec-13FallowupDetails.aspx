...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <asp:TextBox ID="TextBoxpolno" placeholder="enter address1" class="form-control" Width="60%" runat="server"></asp:TextBox></br>
                      <label for="email">Business closed date</label>
        <asp:TextBox ID="TextBoxaddbusclosdate" placeholder="enter address2" class="form-control" Width="60%" runat="server"></asp:TextBox></br>
