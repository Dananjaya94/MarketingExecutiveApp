...
public partial class AllIslandPromotion : System.Web.UI.Page
{
    ...
    public int SaveAllEntry()
    {
        if (ValidationCustomerDetails())
        {
            ...
            try
            {
                ...
                //cmd.Parameters.Add("wkmev_lat", OracleType.VarChar, 500).Value = "1";// lat;
                //cmd.Parameters.Add("wkmev_lon", OracleType.VarChar, 500).Value = "1";//lon;
    ...
    public int SaveVisitEntry()
    {
        ...
        if (ValidationCustomerDetails())
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("wkmev_remarks", OracleType.VarChar, 100).Value = txtremarks.Text;
                //cmd.Parameters.Add("wkmev_lat", OracleType.VarChar, 500).Value = "1"; //lat;
                //cmd.Parameters.Add("wkmev_lon", OracleType.VarChar, 500).Value = "2";// lon;
    ...
    protected void ButtonSave_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Enable Location Service');", true);
        }
