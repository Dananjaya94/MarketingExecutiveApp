<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerMePersonalProdtAchievement.aspx.cs" Inherits="ManagerMeProductAchievement" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ME Wise Refund Ration</title>
    <meta charset="utf-8">
...
;">
    <h1 style="text-align:center;background-color:#000b19;color:#fff;font-weight:bolder;font-family:Calibri;letter-spacing:7px;word-spacing:15px;">ME Wise Personal Product Achievement</h1>
    <!--customer details-->   
