<%@ Page Language="C#" AutoEventWireup="true" CodeFile="managerbranchdebitinfo.aspx.cs" Inherits="managerbranchdebitinfo" %>
...
<div class="container" style="padding-left:5%;background-color:#b4f9e3;">
    <h1 style="text-align:center;background-color:#000b19;color:#fff;font-weight:bolder;font-family:Calibri;letter-spacing:7px;word-spacing:15px;">Branch Debit Information</h1>
    <!--customer details-->   
