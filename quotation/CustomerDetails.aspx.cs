...
public partial class AllIslandPromotion : System.Web.UI.Page
{
    ...
    private void Clear()
    {
        ...
        txtbisoccupation.BorderColor = System.Drawing.Color.Black;
        ...
        DropDownListbusinesscl.BorderColor = System.Drawing.Color.Black;
    ...
    private Boolean ValidationCustomerDetails()
    {
        ...
        if (txtbisoccupation.Text.Equals(""))
        {
            status = false;
            txtbisoccupation.BorderColor = System.Drawing.Color.Red;
        }
        else
        {
            txtbisoccupation.BorderColor = System.Drawing.Color.Black;
        ...
        if (txtbisoccupationcode.Text.Equals(""))
        {
            status = false;
            txtbisoccupation.BorderColor = System.Drawing.Color.Red;
            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Select Occupation from the list ');", true);
        ...
        //if (TextBoxleasingcode.Text.Equals(""))
        //{
        //    status = false;
        //    TextBoxleasing.BorderColor = System.Drawing.Color.Red;
        //    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Select Leasing Company from the list ');", true);

        //}
        //else
        //{
        //    TextBoxleasing.BorderColor = System.Drawing.Color.Black;
        //}
        ...
        if (lblcity.Text.Equals(""))
        {
            status = false;
            TextBoxcity.BorderColor = System.Drawing.Color.Red;
            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Select City from the list ');", true);
        ...
        if (DropDownListreferal.SelectedValue.Equals(""))
        {
            status = false;
            DropDownListreferal.BorderColor = System.Drawing.Color.Red;
            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Select Referrel from list');", true);

        }
        else
        {
            DropDownListreferal.BorderColor = System.Drawing.Color.Black;
        }
    ...
    public int SaveAllEntry()
    {
        if (ValidationCustomerDetails())
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("wkmev_bus_occupation", OracleType.VarChar, 50).Value = txtbisoccupationcode.Text; ////cmbbisocu.SelectedItem.Text;
                ...
                cmd.Parameters.Add("wkmev_referal", OracleType.VarChar, 3).Value = DropDownListreferal.SelectedValue;
                cmd.Parameters.Add("wkmev_referalgiven", OracleType.VarChar, 50).Value = txtreferalgiven.Text;
    ...
    protected void txtbisoccupation_TextChanged(object sender, EventArgs e)
    {
        if (txtbisoccupation.Text.Trim()=="")
        {
            txtbisoccupationcode.Text = "";
        }
    }

    protected void TextBoxleasing_TextChanged(object sender, EventArgs e)
    {
        if (TextBoxleasingcode.Text.Trim() == "")
        {
            TextBoxleasing.Text = "";
        }
    }
