...
public partial class mecollectionreport : System.Web.UI.Page
{
    Connection db;
    ...
    protected void getMeData()
    {
        ...
        cmd.CommandText = "pk_app_me_reports.open_ME_collection_summery";
        ...
        OracleParameter prm6 = new OracleParameter("wkme", OracleType.VarChar);
