<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IntClaim.aspx.cs" Inherits="quotation" %>
...
<%--          <table  id="pnlGridView" runat="server" >
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <asp:TextBox ID="txtfromdate" runat="server" class="form-control form-control-sm" ></asp:TextBox>

    <label>To Date</label>
    <asp:TextBox ID="txttodate" runat="server" class="form-control form-control-sm"></asp:TextBox>
       <br />
...
<%--    <asp:UpdatePanel ID="UpdatePanel2" runat="server" >
        <ContentTemplate>--%>
                  ...
                  <div class="row" style="padding-bottom:5px">
                      <div class="col-md-1">
    <asp:Button ID="btngetMe" CssClass="btn btn-info" runat="server" Text="Get Data" OnClick="btngetMe_Click" />
                      </div>
            <div class="col-md-1">
