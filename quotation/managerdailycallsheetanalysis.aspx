<%@ Page Language="C#" AutoEventWireup="true" CodeFile="managerdailycallsheetanalysis.aspx.cs" Inherits="managerdailycallsheetanalysis" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ME Daily Call Sheet Analysis</title>
    <meta charset="utf-8">
...
;">
    <h1 style="text-align:center;background-color:#000b19;color:#fff;font-weight:bolder;font-family:Calibri;letter-spacing:7px;word-spacing:15px;">ME Daily Call Sheet Analysis </h1>
    <!--customer details-->   
...
<td style="padding: 5px;"><asp:Label ID="Label2" runat="server" Text="Start Date"></asp:Label></td>
...
<td style="padding: 5px;"><asp:TextBox ID="txtfromdate"  runat="server" class="form-control"  Width="286px" ></asp:TextBox>
    ...
    <tr>
 <td style="padding: 5px;"><asp:Label ID="Label1" runat="server" Text="End Date"></asp:Label></td>
...
<td style="padding: 5px;"><asp:TextBox ID="txttodate"  runat="server" class="form-control"  Width="286px"></asp:TextBox>
           ...
           <tr>
        <td style="padding: 5px;"><asp:Label ID="Label3" runat="server" Text="Filter Type"></asp:Label></td>
                <td style="padding: 5px;">
                <asp:DropDownList ID="DropDownListfilter" AppendDataBoundItems="true"  runat="server" class="form-control"  Width="286px"></asp:DropDownList>
                </td>
            </tr>
...
<%--                        <asp:Panel ID="Panel2" runat="server" Height="400px" ScrollBars="Both" >--%>
                           <asp:GridView ID="grid1" runat="server"  CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="true" AutoPostBack="true"  
                               AlternatingRowStyle-BackColor="WhiteSmoke" FooterStyle-BackColor="WhiteSmoke" ShowFooter="true">
