...
<head runat="server">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <script type ="text/javascript" src="assets/js/rolldate.js"></script>
   <style type="text/css">
       body
       {
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <asp:TextBox class="form-control" ID="TextBoxvisitDate" placeholder="MM/DD/YYYY" Width="40%" runat="server"></asp:TextBox></br>
        <%--<asp:TextBox ID="TextBoxvisitDate" type="date" placeholder="enter date" class="form-control" Width="40%" runat="server" ></asp:TextBox></br>--%>
...
<%--        <asp:DropDownList ID="cmbbisocu" runat="server"   Width="40%"
                                                class="form-control" AppendDataBoundItems="True"  style="border-style:solid" ></asp:DropDownList>--%>
                   <asp:TextBox ID="txtbisoccupation" placeholder="enter business occupation" class="form-control" Width="60%" runat="server"></asp:TextBox></br>
...
<span id="lblError" style="color: red"></span>
        ...
        <asp:TextBox ID="TextBoxpolno" placeholder="enter policy no"    class="form-control" Width="60%" runat="server" style="display:none">
        </asp:TextBox>
        ...
        <asp:TextBox ID="TextBoxfalldate"  placeholder="enter followup date"  style="display:none"  class="form-control" Width="60%" runat="server" >
           ...
           <label for="email"  id="lblreferal">Referral *</label>
        <asp:DropDownList ID="DropDownListreferal" runat="server"   Width="60%"
          style="border-style:solid" class="form-control"   >
           ...
           <label for="email" style="display:none"  id="lblreferalgiven">Referral Given By</label>
        <asp:TextBox ID="txtreferalgiven" placeholder="enter Referal Given By"   class="form-control" Width="60%" runat="server" style="display:none">
        </asp:TextBox></br>                
    ...
    <%--    <label for="email"> ME</label>
        ...
        <asp:TextBox ID="txtremarks" placeholder="enter remark" class="form-control" Width="60%" runat="server" TextMode="MultiLine"></asp:TextBox></br>
         ...
         <%--<asp:Label runat="server" ID="lblcity"  ></asp:Label>--%><%--type="hidden"--%>
         <asp:TextBox ID="lblcity" placeholder="ME"  type="hidden"  class="form-control" Width="40%" runat="server"></asp:TextBox><%--type="hidden"--%>
         <asp:TextBox ID="TextBoxMe" placeholder="CITY"  type="hidden"  class="form-control" Width="40%" runat="server"></asp:TextBox><%--type="hidden"--%>
        <asp:TextBox ID="TextBoxbranch" placeholder="BRANCH"  type="hidden" class="form-control" Width="40%" runat="server"></asp:TextBox>
        <asp:TextBox ID="TextBoxmecode" placeholder="MECODE"  type="hidden"  class="form-control" Width="40%" runat="server"></asp:TextBox>
        <asp:TextBox ID="TextBoxCusCode" placeholder="CUSCODE" type="hidden"  class="form-control" Width="40%" runat="server"></asp:TextBox>
        <asp:TextBox ID="TextBoxVisitNo" placeholder="VISITNO" type="hidden"   class="form-control" Width="40%" runat="server"></asp:TextBox>
        <asp:TextBox ID="TextBoxleasingcode" placeholder="LEASINGCODE"  type="hidden"  class="form-control" Width="40%" runat="server"></asp:TextBox>
        <asp:TextBox ID="txtbisoccupationcode" placeholder="OCCCODE" type="hidden"  class="form-control" Width="40%" runat="server"></asp:TextBox>
      ...
      <script>
         ...
         $("#<%=TextBoxleasing.ClientID %>").autocomplete({
                ...
                select: function (e, i) {
                    ...
                    $("[id$=TextBoxleasingcode]").val(i.item.val);
          ...
          $(function () {
              $("#DropDownListreferal").change(function () {
                  if ($(this).val() == "Y") {
                      $("#lblreferalgiven").show();
                      $("#txtreferalgiven").show();
                      //$("#lblfollowup").hide();
                      //$("#TextBoxfalldate").hide();
                      //$("#labelredate").hide();
                      //$("#TextBoxredate").hide();
                      ...
                      $("#lblreferalgiven").hide();
                      $("#txtreferalgiven").hide();
                      //$("#lblfollowup").show();
                      //$("#TextBoxfalldate").show();
                      //$("#labelredate").show();
                      //$("#TextBoxredate").show();
